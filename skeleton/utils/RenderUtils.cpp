...
extern void mouseClick(int button, int state);
...
{
	StartCounter();
	sCamera = new Camera(PxVec3(0.0f, 30.0f, 120.0f), PxVec3(0.f,0.f,-0.1f));

	setupDefaultWindow("SIM Practica 4");
	...
	motionCallback(sCamera->getDir().x, sCamera->getDir().y);
